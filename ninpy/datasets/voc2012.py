...
class BaseDataset(data.Dataset):
    def __init__(
        self, root, split, mode=None, transform=None,
...
class VOCSegmentation(BaseDataset):
    ...
    def __init__(
        self, root=os.path.expanduser('~/datasets/VOC'), split='train',
...
class VOCAugSegmentation(BaseDataset):
    ...
    def __init__(self, root=os.path.expanduser('~/datasets/VOC'), split='train',
                 mode=None, transform=None, target_transform=None, **kwargs):
